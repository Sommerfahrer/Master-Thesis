    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{ganttchart}[%
                ...
                bar height=1,
                bar top shift = 0]{0}{11}
                \ganttbar[inline=false, bar/.append style={fill=blue!50}, bar label font=\color{blue!50}]{Task ohne 'Blocked'}{0}{2}
                \ganttbar[bar/.append style={fill=blue!50}]{}{6}{8}\\
                \gantttitlelist[title label node/.append style={alias=n\x,opacity=0}]{0,...,11}{1}
            \end{ganttchart}
            \draw [-latex] (n0.north west) -- ([xshift=7pt]n11.north east) node[right] {$t$};
            \foreach \N in {0,...,11} {
        ...
        \begin{tikzpicture}
            \begin{ganttchart}[%
                ...
                bar height=1,
                bar top shift = 0]{0}{11}
            \ganttbar[inline=false, bar/.append style={fill=blue!50}, bar label font=\color{blue!50}]{Task mit 'Blocked'}{0}{0}
            \ganttbar[bar/.append style={fill=blue!50}]{}{6}{7}\\
            \ganttvrule[vrule/.append style={red}]{Blocked}{0}
            \ganttvrule[vrule/.append style={red}]{Continued}{5}
            \gantttitlelist[title label node/.append style={alias=n\x,opacity=0}]{0,...,11}{1}
            \end{ganttchart}
            \draw [-latex] (n0.north west) -- ([xshift=7pt]n11.north east) node[right] {$t$};
            \foreach \N in {0,...,11} {
        ...
        \begin{tabular}{l|c|c|c}
            Taskname & Periode & Deadline & \ac{wcet} \\
            \hline
            Task mit 'Blocked' & 6 & 6 & 3 \\
            Task ohne 'Blocked' & 6 & 6 & 3 
        \end{tabular}
