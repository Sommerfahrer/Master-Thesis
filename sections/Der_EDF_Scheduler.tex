...
\subsection{Fehlerbehandlung} \label{section:Fehlerbehandlung}
    ...
    \begin{table}[ht!]
        ...
        \begin{tabular}{l|c|c|c}
            ...
            Task 3 & 2 & 2 & 1 
        \end{tabular}
        \caption{Beispiel Deadline Errors Task Parameter}
        \label{table:beispiel_deadline_erros_task_parameter}
    \end{table}
    ...
    \begin{figure}[ht!]
        ...
        \ganttvrule[vrule/.append style={red}]{}{1}
        \ganttvrule[vrule/.append style={red}]{}{3}
        \ganttvrule[vrule/.append style={red}]{}{5}
        \ganttvrule[vrule/.append style={red}]{}{7}
        \ganttvrule[vrule/.append style={red}]{}{9}
